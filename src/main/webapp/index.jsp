...
<html lang="en">
  ...
  <head>
    ...
    <title>Julio Trujillo Alvarado</title>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="my-auto">
          ...
          <ul class="list-inline list-social-icons mb-0">
            <li class="list-inline-item">
              <a href="https://www.facebook.com/juliotrujilloalvarado" target="_blank">
            ...
            <li class="list-inline-item">
              <a href="https://twitter.com/Julio_T_A" target="_blank">
                <span class="fa-stack fa-lg">
                  <i class="fa fa-circle fa-stack-2x"></i>
            ...
            <li class="list-inline-item">
              <a href="https://www.linkedin.com/in/juliotrujilloalvarado/" target="_blank">
                <span class="fa-stack fa-lg">
                  <i class="fa fa-circle fa-stack-2x"></i>
            ...
            <li class="list-inline-item">
              <a href="https://github.com/JulioTrujilloA" target="_blank">
                <span class="fa-stack fa-lg">
                  <i class="fa fa-circle fa-stack-2x"></i>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="interests">
        <div class="my-auto">
          ...
          <p>Apart from being a backend developer, I enjoy most of my time reading books and playing the guitar. I enjoy walking with my dog outdoors. I am use to travel to my town to release stress and visit to my family.</p>
          <p class="mb-0">When I am indoors, I am an aspiring dancer, and I spend a large amount of my free time practicing. I also spent my free time reading advancements in the IT and Science areas.</p>
        </div>
      </section>
